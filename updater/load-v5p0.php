...
namespace TMM\PluginUpdateChecker\v5p0;

use TMM\PluginUpdateChecker\v5\PucFactory as MajorFactory;
use TMM\PluginUpdateChecker\v5p0\PucFactory as MinorFactory;
