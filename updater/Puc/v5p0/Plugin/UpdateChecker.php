<?php
namespace TMM\PluginUpdateChecker\v5p0\Plugin;

use TMM\PluginUpdateChecker\v5p0\InstalledPackage;
use TMM\PluginUpdateChecker\v5p0\UpdateChecker as BaseUpdateChecker;
use TMM\PluginUpdateChecker\v5p0\Scheduler;
use TMM\PluginUpdateChecker\v5p0\DebugBar;
...
if ( ! class_exists( UpdateChecker::class, false ) ) :
	...
	class UpdateChecker extends BaseUpdateChecker {
		...
		public function __construct( $metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '' ) {
			...
			//Details: https://github.com/Bonn/plugin-update-checker/issues/138#issuecomment-335590964
